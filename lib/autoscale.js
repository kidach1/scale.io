...
Autoscale.prototype._checkBySpecifiedTime = (connNumsOfGreenHosts) => {
  log.autoscale.info('connNumsOfGreenHosts.length', connNumsOfGreenHosts.length * config.get('serverTypeNum'));
  if (connNumsOfGreenHosts.length * config.get('serverTypeNum') >= config.get('specifiedTimeGreenHostsNum')) return false;
